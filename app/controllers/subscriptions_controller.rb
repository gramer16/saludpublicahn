class SubscriptionsController < ApplicationController
  ...
  def create
    ...
    if @subscription.save_with_payment
      redirect_to  @subscription, :notice => "Gracias por Subscribir! Nuestro Equipo de The World Only le contactara muy pronto para solicitar informacion adicional para publicar su perfil en nuestro website"
    else
      render :new
    end
  end
  ...
  private
    ...
    def check_user
        unless current_user.admin?
         redirect_to root_url, alert: "Sorry, Only The World's Only Admin can Delete a Subscription"
    end
end
end
